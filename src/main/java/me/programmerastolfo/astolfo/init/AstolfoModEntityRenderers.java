...
import me.programmerastolfo.astolfo.client.renderer.VentiRenderer;
import me.programmerastolfo.astolfo.client.renderer.SiegRenderer;
import me.programmerastolfo.astolfo.client.renderer.RimuruRenderer;
import me.programmerastolfo.astolfo.client.renderer.NagisaShiotaRenderer;
import me.programmerastolfo.astolfo.client.renderer.HideriKanzakiRenderer;
import me.programmerastolfo.astolfo.client.renderer.FelixRenderer;
import me.programmerastolfo.astolfo.client.renderer.BridgetRenderer;
...
public class AstolfoModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(AstolfoModEntities.HIDERI_KANZAKI.get(), HideriKanzakiRenderer::new);
		event.registerEntityRenderer(AstolfoModEntities.VENTI.get(), VentiRenderer::new);
		event.registerEntityRenderer(AstolfoModEntities.RIMURU.get(), RimuruRenderer::new);
		event.registerEntityRenderer(AstolfoModEntities.NAGISA_SHIOTA.get(), NagisaShiotaRenderer::new);
		event.registerEntityRenderer(AstolfoModEntities.SIEG.get(), SiegRenderer::new);
		event.registerEntityRenderer(AstolfoModEntities.BRIDGET.get(), BridgetRenderer::new);
	}
}
