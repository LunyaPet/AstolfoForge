...
public class AstolfoforgeMod {
	...
	public AstolfoforgeMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		AstolfoforgeModSounds.REGISTRY.register(bus);
		AstolfoforgeModBlocks.REGISTRY.register(bus);

		AstolfoforgeModItems.REGISTRY.register(bus);
		AstolfoforgeModEntities.REGISTRY.register(bus);

		AstolfoforgeModTabs.REGISTRY.register(bus);
